...
- **NEVER** edit code yourself -- delegate every code change to the `go-fixer` agent via the "Apply fixes" handoff
- If `go-fixer` cannot be invoked, **report the actual error and stop** -- never fall back to editing code directly
